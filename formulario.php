        ...
        <div class="row">
          <div class="col-xs-12 col-md-4 col-sm-6">
            <div class=" form-group">
              ...
              <input type="tel" name="telefone" pattern="[-0-9]+" required class="form-control" value="">
            </div>
          </div>
          <div class="col-xs-12 col-md-4 col-sm-6">
            <div class=" form-group">
              <label for="form">Email</label>
              <input type="email" name="email" autocomplete="on" required placeholder="senac@senac.com" class="form-control" value="">
            </div>
          </div>

          <div class="col-xs-12 col-md-4 col-sm-6">
            <div class=" form-group">
              <label for="form">Hora</label>
